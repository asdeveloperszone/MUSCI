...
class ArtistSongsActivity : BasePlayerActivity() {
    ...
    private fun loadSongs(artistId: Long): List<Song> {
        ...
        try {
            ...
            contentResolver.query(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, proj,
                ...
                arrayOf(artistId.toString()), "${MediaStore.Audio.Media.TITLE} ASC")?.use { c ->
